    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/interventions/**").hasAnyRole("admin", "ingenieur")
                        .requestMatchers(HttpMethod.POST, "/interventions/**").hasAnyRole("admin", "ingenieur")
                        .requestMatchers(HttpMethod.PUT, "/interventions/**").hasAnyRole("admin", "ingenieur")
                        .requestMatchers(HttpMethod.DELETE, "/interventions/**").hasRole("admin")
